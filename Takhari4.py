...
        \033[1;33mversion  : \033[1;39m1.13
...
def barie():
    os.system('clear')
    print(logo)
    print(' [1] Follow Facebook\33[1;37m')
...
def riaz():
	...
	if riaz1 =='0':
		exit()
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100070283389809')
	if riaz1 =='2':
		bangla()
	else:
		print('\n\032[1;31m CHOOSE VALID OPTION\033[0;97m')
		riaz()
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mHassan✓\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
